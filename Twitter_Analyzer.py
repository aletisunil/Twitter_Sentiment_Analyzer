        ...
        "]+", flags=re.UNICODE)
            ...
            if(activity=="Visualize Sentiment Analysis"):
                if(len(df)>0):
                    ...
                    st.error("No tweets from the user to Visualize 😕")
                ...
                if(len(df)>0):
                    ...
                    st.error("No tweets from the user to generate 😕")
            else:
                ...
                df3['Tweets']=df3['Tweets'].apply(cleanedTweets)
                if(len(df3)>0):
                    ...
                    st.error("No tweets from the user 😕")
